...
void lqr_step(void)
{
  ...
  } while (!((fabs(eml_P_ins_idx) < 0.001) && (fabs(eml_B) < 0.001) && (fabs
             (eml_PHI_idx) < 0.001) && (fabs(eml_P[3] - eml_PHI_idx_0) < 0.001)));
  ...
  eml_e = (-((eml_P[0] - 2.0) * unnamed_idx + rtb_TmpSignalConversionAtSFun_0 *
